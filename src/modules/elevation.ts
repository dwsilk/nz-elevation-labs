...
export const PRESETS: ColourPreset[] = [
  { name: 'Terrain', stops: [
    { e: 0, c: '#0a5c36' }, { e: 300, c: '#4a9e3f' }, { e: 800, c: '#c8b56e' },
    { e: 1500, c: '#a07850' }, { e: 2000, c: '#7a5a3a' }, { e: 2500, c: '#c8c8c8' }, { e: 3000, c: '#ffffff' },
  ]},
  { name: 'Hypsometric', stops: [
  ...
  { name: 'Bathymetric', stops: [
    { e: 0, c: '#08306b' }, { e: 200, c: '#08519c' }, { e: 600, c: '#2171b5' },
    { e: 1000, c: '#4292c6' }, { e: 1600, c: '#74c476' }, { e: 2200, c: '#c8b56e' },
    { e: 2700, c: '#d0d0d0' }, { e: 3000, c: '#ffffff' },
  ]},
  { name: 'Viridis', stops: [
    { e: 0, c: '#440154' }, { e: 500, c: '#31688e' }, { e: 1000, c: '#35b779' },
    { e: 1800, c: '#90d743' }, { e: 3000, c: '#fde725' },
  ]},
  { name: 'Plasma', stops: [
    { e: 0, c: '#0d0887' }, { e: 600, c: '#7e03a8' }, { e: 1200, c: '#cc4778' },
    { e: 2000, c: '#f89540' }, { e: 3000, c: '#f0f921' },
  ]},
  { name: 'Inferno', stops: [
    { e: 0, c: '#000004' }, { e: 400, c: '#420a68' }, { e: 900, c: '#932667' },
    { e: 1400, c: '#dd513a' }, { e: 2000, c: '#fca50a' }, { e: 3000, c: '#fcffa4' },
  ]},
  { name: 'Cividis', stops: [
    { e: 0, c: '#00204d' }, { e: 500, c: '#31446b' }, { e: 1000, c: '#666870' },
    { e: 1500, c: '#958f78' }, { e: 2000, c: '#c4b86a' }, { e: 3000, c: '#ffea46' },
  ]},
  { name: 'Cool-Warm', stops: [
    { e: 0, c: '#313695' }, { e: 600, c: '#4575b4' }, { e: 1000, c: '#74add1' },
    { e: 1500, c: '#fdae61' }, { e: 2100, c: '#f46d43' }, { e: 3000, c: '#a50026' },
  ]},
  { name: 'Spectral', stops: [
    { e: 0, c: '#9e0142' }, { e: 500, c: '#f46d43' }, { e: 1000, c: '#fee08b' },
    { e: 1500, c: '#e6f598' }, { e: 2000, c: '#66c2a5' }, { e: 3000, c: '#5e4fa2' },
  ]},
  { name: 'Arctic', stops: [
    { e: 0, c: '#1a3a5c' }, { e: 400, c: '#2e7bb4' }, { e: 900, c: '#74bcd4' },
    { e: 1500, c: '#c8e8f0' }, { e: 2200, c: '#e8f4f8' }, { e: 3000, c: '#ffffff' },
  ]},
  { name: 'Greyscale', stops: [
    { e: 0, c: '#111111' }, { e: 3000, c: '#ffffff' },
  ]},
];
...
export function setStops(newStops: ColourStop[]): void { stops = newStops; }
export function setActivePreset(i: number): void { activePreset = i; }
